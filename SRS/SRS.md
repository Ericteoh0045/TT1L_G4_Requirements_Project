...
- 1. Introduction [11](#introduction)
  ...
  - 1.3 Product Perspective [11](#product-perspective)
    - 1.3.1 System Interface [12](#system-interface)
    - 1.3.2 User Interface [13](#user-interface)
    - 1.3.3 Hardware Interface [14](#hardware-interface)
    - 1.3.4 Software Interface [15](#software-interface)
    - 1.3.5 Communication Interface [16](#communication-interface)
  - 1.4 Product Functions [17](#product-functions)
  - 1.5 User Characteristics [19](#user-characteristics)
  - 1.6 Limitations [20](#limitations)
...
- 2. Requirements [23](#requirements)
  - 2.1 External Interfaces [23](#external-interfaces)
    ...
    - 2.1.3 Event Details [25](#event-details)
    - 2.1.4 Register for Event [27](#register-for-event)
    - 2.1.5 Make Payment [29](#make-payment)
    - 2.1.6 Receive e-ticket/QR code [30](#receive-e-ticketqr-code)
    - 2.1.7 View Registration History [31](#view-registration-history)
    - 2.1.8 Show QR Attendance [32](#show-qr-attendance)
    - 2.1.9 Set Event Details [34](#set-event-details)
    - 2.1.10 View Events (Organizer) [36](#view-events-organizer)
    - 2.1.11 View Registrations and Attendance Status [37](#view-registrations-and-attendance-status)
  - 2.2 Functions [38](#functions)
    - 2.2.1 F00 View Upcoming Events [38](#f00-view-upcoming-events)
    - 2.2.2 F01 View Event Details [39](#f01-view-event-details)
    - 2.2.3 F02 Register for Event [41](#f02-register-for-event)
    - 2.2.4 F03 Make Payment [44](#f03-make-payment)
    - 2.2.5 F04 Receive e-Ticket/QR Code [47](#f04-receive-e-ticketqr-code)
    - 2.2.6 F05 View Registration History [48](#f05-view-registration-history)
    - 2.2.7 F06 Show QR Attendance [51](#f06-show-qr-attendance)
    - 2.2.8 F07 Create a New Event & F08 Set Event Details [52](#f07-create-a-new-event-f08-set-event-details)
    - 2.2.9 F09 View Events [54](#f09-view-events)
    - 2.2.10 F10 View Registrations & Attendance Status [56](#f10-view-registrations-attendance-status)
    - 2.2.11 F11 Check-in Upon Arrival [58](#f11-check-in-upon-arrival)
    - 2.2.12 F12 Login [59](#f12-login)
  - 2.3 State Transition Diagrams [61](#state-transition-diagrams)
  - 2.4 Performance Requirements [62](#performance-requirements)
  - 2.5 Security Requirements [63](#security-requirements)
  - 2.6 Usability Requirements [64](#usability-requirements)
  - 2.7 Logical Database Requirements [65](#logical-database-requirements)
    - 2.7.1 Event Table [66](#event-table)
    - 2.7.2 Registration Table [67](#registration-table)
    - 2.7.3 Payment Table [67](#payment-table)
  - 2.8 Design Constraints [68](#design-constraints)
  - 2.9 Software System Attributes [69](#software-system-attributes)
  - 2.10 Supporting Information [70](#supporting-information)
    - 2.10.1 Interview [71](#interview)
    - 2.10.2 Questionnaires [72](#questionnaires)
    - 2.10.3 Observation [73](#observation)

- 3. Verification [74](#verification)
  - 3.1 Inspection [74](#inspection)
  - 3.2 Walkthroughs [75](#walkthroughs)
  - 3.3 Prototyping [75](#prototyping)

- 4. Appendices [76](#appendices)
- 5. References [78](#references)



# List of Figures 

[Figure 2.2.1. 1 F00 View Upcoming Events Sequence Diagram
...
[Table 1.3.4. 1 Software Interface Requirements
...
[Table 2.1.5. 1 REQ_IO0401 Table [29](#_Ref199051573)](#_Ref199051573)
...
[Table 2.1.11. 1 REQ_IO1001 Table [37](#_Ref199052009)](#_Ref199052009)
...
[Table 2.2.5. 2 F04 Receive e-Ticket/QR Code Use Case Specification
...
[Table 2.2.12. 1 REQ_F1201 Table [59](#_Ref199052978)](#_Ref199052978)
